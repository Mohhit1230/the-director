...
export default function AddressBook() {
    ...
    const handleDelete = (id) => {
        ...
        if (addressToDelete?.isDefault && addresses.length > 1) {
            toast.show('Cannot delete default address. Set another address as default first.', { type: 'error' });
            return;
        }
    ...
    const handleSubmit = (e) => {
        ...
        if (!formData.label || !formData.street || !formData.city || !formData.zip) {
            ...
            {!showModal ? (
                ...
                <>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6 w-full">
                        <div>
                            <label className="block text-sm font-medium text-gray-900 mb-2">Address Label *</label>
                            <input
                                type="text"
                                name="label"
