...
export default function PaymentOptions() {
    ...
    const handleDelete = (id) => {
        ...
        if (cardToDelete?.isDefault && cards.length > 1) {
            toast.show('Cannot delete default card. Set another card as default first.', { type: 'error' });
            return;
        }
    ...
    const handleSubmit = (e) => {
        ...
        if (!formData.holderName || !formData.expiryMonth || !formData.expiryYear || !formData.cvv) {
            ...
            {!showModal ? (
                <>
                    <div className="flex justify-between items-center mb-8">
                        <h2 className="text-3xl font-bold text-[#fd4444]">My Payment Options</h2>
                        <button
                                ...
                                {cards.map((card) => (
                                    ...
                                    >
                                        ...
                                        <div className="space-y-4">
                                            <p className="text-xl tracking-wider font-mono">•••• •••• •••• {card.cardNumber}</p>
                            ...
                            <div className="mt-8 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                                <div className="flex gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-blue-700 mt-1">Your payment information is encrypted and stored securely. We never share your card details with third parties.</p>
                                    </div>
                                </div>
                            </div>
                        </>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6 w-full">
                        <div className="w-full flex gap-4">
                            ...
                            <input
                                ...
                                required
                            />
                            <p className="text-xs text-gray-500 mt-1">Detected: {detectCardType(formData.cardNumber)}</p>
                        </div>
