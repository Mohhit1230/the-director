...
export default function Cancellations() {
    ...
    // Sample cancellations data - in a real app, this would come from an API
    ...
    return (
        <div className="min-h-screen py-20 mt-12">
            <div className="max-w-7xl mx-auto px-6">
                {/* Header */}
                <div className="mb-8">
                    <h1 className="text-4xl font-bold text-[#ffad33] mb-2">My Cancellations</h1>
                    <p className="text-gray-300">Track your order cancellation requests and refunds</p>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
                    ...
                    <div className="lg:col-span-3 space-y-6">
                        ...
                        {filteredCancellations.length === 0 ? (
                            <div className="bg-white/95 rounded-lg border border-[#ffad33] p-12 text-center">
                                ...
                                <p className="text-gray-400 text-lg mb-2">No cancellations found</p>
                                    ...
                                    >
                                        ...
                                        <div className="flex items-center justify-between mb-4 pb-4 border-b border-gray-700">
                                            ...
                                            <div className="flex items-center gap-2">
                                                ...
                                                <span className={`px-3 py-1 rounded-full text-xs font-medium ${getStatusColor(cancellation.status)}`}>
                                        ...
                                        <div className="flex items-start gap-4 mb-4">
                                            ...
                                            <div className="flex-1">
                                                <h3 className="text-[#ffad33] font-medium mb-1">{cancellation.productName}</h3>
                                                <div className="text-sm text-gray-700 space-y-1">
                                                    <p>Quantity: <span className='text-black font-medium'>{cancellation.quantity}</span></p>
                                                    <p className=''>Price: <span className='text-black font-medium'>${cancellation.price}</span></p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="bg-black/90 rounded-lg p-4 space-y-3">
                                            <div>
                                                <span className="text-sm text-gray-400">Reason for Cancellation:</span>
                                            ...
                                            <div className="grid grid-cols-2 gap-4 text-sm">
                                                <div>
                                                    ...
                                                    <p className="text-white">
                                                        {new Date(cancellation.requestDate).toLocaleDateString('en-US', {
                                                            year: 'numeric',
                                                            month: 'short',
                                                            day: 'numeric'
                                                        })}
                                                ...
                                                {cancellation.status === 'approved' && (
                                                    <>
                                                        <div>
                                                            ...
                                                            <p className="text-green-400 font-semibold">${cancellation.refundAmount}</p>
                                                        </div>
                                                        <div>
                                                            <span className="text-gray-400">Refund Date:</span>
                                                            <p className="text-white">
                                                                {new Date(cancellation.refundDate).toLocaleDateString('en-US', {
                                                                    year: 'numeric',
                                                                    month: 'short',
                                                                    day: 'numeric'
                                                                })}
                                                ...
                                                {cancellation.status === 'rejected' && (
                                                    <div className="col-span-2">
                                                        ...
                                                        <p className="text-red-400 mt-1">{cancellation.rejectionReason}</p>
                                                    </div>
                                                )}
                                            </div>
                                        </div>
                                        ...
                                        {cancellation.status === 'pending' && (
                                            <div className="mt-4 flex gap-3">
                                                <button
                                                    onClick={() => toast.show('Contact support to modify your request', { type: 'info' })}
                    ...
                    <aside className="lg:col-span-1">
                        <div className="bg-white/95  rounded-lg border-2 border-[#ffad33] p-6 sticky top-24">
                            <h3 className="text-lg font-semibold text-[#ffad33] mb-4">Cancellation Summary</h3>

                            <div className="space-y-4">
                                <div>
                                    <div className="text-sm text-gray-700 mb-1">Total Requests</div>
                                ...
                                <div className="border-t border-gray-700 pt-4 space-y-3">
                                    <div className="flex items-center justify-between">
                                        ...
                                        <span className="text-green-500 font-medium">{stats.approved}</span>
                                    </div>
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center gap-2">
                                ...
                                <div className="border-t border-gray-700 pt-4">
                                    <div className="text-sm text-gray-700 mb-1">Total Refunded</div>
                                    <div className="text-2xl font-bold text-green-500">${stats.totalRefunded}</div>
                                </div>
                            </div>
