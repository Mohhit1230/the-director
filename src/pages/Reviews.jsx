    ...
    const [reviews, setReviews] = useState([
        {
            ...
            comment: 'This gamepad is amazing! Very comfortable to hold and the buttons are very responsive. Highly recommend for gaming enthusiasts.',
            date: '2024-01-15',
            status: 'published',
            helpful: 12
        },
        {
            ...
            comment: 'Good build quality and nice RGB lighting. The only downside is that it can be a bit loud when typing.',
            date: '2024-01-10',
            status: 'published',
            helpful: 8
        },
        {
            ...
            comment: 'Crystal clear display with amazing colors. Perfect for both gaming and work. Worth every penny!',
            date: '2024-01-05',
            status: 'pending',
            helpful: 0
        }
    ...
    return (
        <div className="min-h-screen py-20 mt-12">
            <div className="max-w-7xl mx-auto px-6">
                {/* Header */}
                <div className="mb-8">
                    <h1 className="text-4xl font-bold text-[#ffad33] mb-2">My Reviews</h1>
                    <p className="text-gray-300">Manage your product reviews and ratings</p>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
                    ...
                    <div className="lg:col-span-3 space-y-6">
                        ...
                        <div className="flex gap-4 border-b border-gray-300 pb-4">
                            ...
                            <button
                                ...
                                className={`px-4 py-2 font-medium transition-colors ${filter === 'published'
                                        ? 'text-[#ffad33] border-b-2 border-[#ffad33]'
                                        : 'text-gray-300 hover:text-[#ffad33]'
                                    }`}
                            >
                        ...
                        {filteredReviews.length === 0 ? (
                            ...
                            <div className="space-y-4">
                                {filteredReviews.map((review) => (
                                    <div
                                        key={review.id}
                                        className="bg-white/95 backdrop-blur-sm rounded-lg border-2 border-[#ffad33] p-6 hover:border-[#ffad33]/50 transition-all"
                                    >
                                        {/* Product Info */}
                                        <div className="flex items-start gap-4 mb-4">
                                            ...
                                            <div className="flex-1">
                                                ...
                                                <div className="flex items-center gap-3 mt-2">
                                                    ...
                                                    <span className={`px-2 py-1 rounded text-xs font-medium ${review.status === 'published'
                                                            ? 'bg-green-500/20 text-green-600'
                                                            : 'bg-yellow-500/40 text-yellow-600'
                                                        }`}>
                                                        {review.status}
                                                    </span>
                                                </div>
                                            ...
                                            <div className="flex gap-2">
                                                <button
                                                    onClick={() => toast.show('Edit functionality coming soon', { type: 'info' })}
                                                    className="p-2 text-gray-600 hover:text-[#ffad33] hover:bg-white/5 rounded transition-colors"
                                                    title="Edit review"
                                                >
                                                ...
                                                <button
                                                    ...
                                                    className="p-2 text-gray-600 hover:text-[#fd4444] hover:bg-white/5 rounded transition-colors"
                                                    title="Delete review"
                                                >
                                        ...
                                        <div className="space-y-2">
                                            <h3 className="text-black font-semibold">{review.title}</h3>
                    ...
                    <aside className="lg:col-span-1">
                        <div className="bg-white/95 rounded-lg border-2 border-[#ffad33] p-6 sticky top-24">
                            <h3 className="text-lg font-semibold text-[#ffad33] mb-4">Review Statistics</h3>

                            <div className="space-y-4">
                                <div>
                                    <div className="text-sm text-gray-800 mb-1">Total Reviews</div>
                                    <div className="text-3xl font-bold text-gray-800">{stats.total}</div>
                                </div>

                                <div className="border-t border-gray-900 pt-4">
                                    <div className="text-sm text-gray-800 mb-1">Average Rating</div>
                                ...
                                <div className="border-t border-gray-900 pt-4 space-y-2">
                                    <div className="flex justify-between text-sm">
                                        ...
                                        <span className="text-green-600 font-medium">{stats.published}</span>
                                    </div>
                                    <div className="flex justify-between text-sm">
                            ...
                            <div className="mt-6 pt-6 border-t border-gray-900">
                                <p className="text-xs text-gray-500">
                                    Your reviews help other customers make informed decisions. Thank you for sharing your experience!
                                </p>
                            </div>
                        </div>
                    </aside>
