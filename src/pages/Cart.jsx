        ...
        <div className="space-y-8">
          ...
          <div className=" shadow-md flex flex-col gap-8">
            ...
            {cart.map((item) => (
              <div
                key={item.id}
                className="grid grid-cols-12 gap-4 py-6 px-12 bg-white items-center  hover:bg-gray-100 rounded-md transition-colors"
              >
                <div className="col-span-5 flex items-center gap-4 relative">
                  ...
                  />
                  <span className="text-[#ffad33] font-medium">
                    {item.name}
                  </span>
                </div>
          ...
          <div className="w-full flex justify-end mt-12">
            <div className="w-1/2 border border-white/20  shadow-md rounded px-8 py-12 flex flex-col gap-4">
              <h3 className="text-xl font-bold text-[#ffad33] mb-6">
                Cart Total
              </h3>
