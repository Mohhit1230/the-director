        ...
        <div className="min-h-screen py-20 mt-12">
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="flex items-center gap-2 text-sm mb-12 text-yellow-600">
                    <Link to="/" className="hover:text-[#ffad33] transition-colors">Account</Link>
                    <span>/</span>
                    <Link to="/account" className="hover:text-[#ffad33] transition-colors">My Account</Link>
                    <span>/</span>
                    <Link to="/product/1" className="hover:text-[#ffad33] transition-colors">Product</Link>
                    <span>/</span>
                    <Link to="/cart" className="hover:text-[#ffad33] transition-colors">View Cart</Link>
                    <span>/</span>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
                    ...
                    <div>
                        <h1 className="text-4xl font-bold text-[#ffad33] mb-12">Billing Details</h1>

                        <form onSubmit={handlePlaceOrder} className="space-y-8">
                            {/* First Name */}
                            <div>
                                <label htmlFor="Name" className="block text-[#ffad33] text-sm mb-2">
                            ...
                            {/* Company Name */}
                            <div>
                                <label htmlFor="companyName" className="block text-[#ffad33] text-sm mb-2">
                                    Company Name
                                </label>
                                <input
                                    type="text"
                            ...
                            {/* Street Address */}
                            <div>
                                <label htmlFor="streetAddress" className="block text-[#ffad33] text-sm mb-2">
                            ...
                            {/* Apartment */}
                            <div>
                                <label htmlFor="apartment" className="block text-[#ffad33] text-sm mb-2">
                            ...
                            {/* Town/City */}
                            <div>
                                <label htmlFor="city" className="block text-[#ffad33] text-sm mb-2">
                            ...
                            {/* Phone Number */}
                            <div>
                                <label htmlFor="phoneNumber" className="block text-[#ffad33] text-sm mb-2">
                            ...
                            {/* Email Address */}
                            <div>
                                <label htmlFor="email" className="block text-[#ffad33] text-sm mb-2">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                />
                                <label htmlFor="saveInfo" className="text-white text-sm cursor-pointer">
                        ...
                        <div className="mt-4 space-y-4">
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <div className="flex items-center gap-2">
                                    <img src="/images/payment/bkash.png" alt="bKash" className="h-6" onError={(e) => e.target.style.display = 'none'} />
                                    <img src="/images/payment/visa.png" alt="Visa" className="h-6" onError={(e) => e.target.style.display = 'none'} />
                                    <img src="/images/payment/mastercard.png" alt="Mastercard" className="h-6" onError={(e) => e.target.style.display = 'none'} />
                                    <img src="/images/payment/nagad.png" alt="Nagad" className="h-6" onError={(e) => e.target.style.display = 'none'} />
                                </div>
                            </div>
