        ...
        <div className="w-full lg:w-[340px] bg-white text-black p-8 rounded shadow-lg h-fit">
          ...
          <div className="flex flex-col gap-4">
            <div className="flex items-center gap-4">
              ...
              <h3 className="font-semibold text-base tracking-wide">Call To Us</h3>
            </div>
            <p className="text-sm tracking-wide">We are available 24/7, 7 days a week.</p>
          ...
          <div className="flex flex-col gap-4">
            <div className="flex items-center gap-4 ">
              ...
              <h3 className="font-semibold text-base tracking-wide">Write To Us</h3>
            </div>
            <p className="text-sm tracking-wide">Fill out our form and we will contact you within 24 hours.</p>
